...
class Alex_net(nn.Module):
    def __init__(self)->None:
        ...
        self.conv1 = nn.Conv2d(in_channels = 1, out_channels = 32, kernel_size = 7, padding = 1, stride = 1)
        self.pool1 = nn.MaxPool2d(kernel_size = 2, stride = 2)
        self.conv2 = nn.Conv2d(in_channels = 32, out_channels = 256, kernel_size = 5, padding = 2, stride = 1)
